module.exports = function (grunt) {
    ...
    grunt.registerTask('build', [
        'clean', 'html2js', 'coffeelint', 'coffee', 'less:build','sass:build',
    ...
    grunt.registerTask('compile', [
        'less:compile', 'sass:compile','copy:compile_assets', 'ngAnnotate', 'concat:compile_js', 'concat:build_css', 'uglify', 'index:compile', 'htmlSnapshot'
    ]);
